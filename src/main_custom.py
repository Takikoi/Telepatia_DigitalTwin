...
def init_wrench(a,i):
  f = open('/home/takikoi/takikoi_ws/Telepatia_DigitalTwin/src/ur10e_msgs_processor/stream/stream_wrench.json')
  data = json.load(f)
  if i == 0:
    return data[a]["x"]
  if i == 1:
  ...
  if i == 2:
    return data[a]["z"]
def init_img():
  f = open('/home/takikoi/takikoi_ws/Telepatia_DigitalTwin/src/yolov5/stream_vid.json')#image proccessing json file
  data = json.load(f)
  return data["num"]

def init_data(a,i):
  path = '/home/takikoi/takikoi_ws/Telepatia_DigitalTwin/src/ur10e_msgs_processor/stream/stream_joint.json' #position and velocity json file
  f = open(path)
  data = json.load(f)
  return data[a][i]
